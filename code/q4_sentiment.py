...
REGULARIZATION = [0.0, 0.00001, 0.00005, 0.0001, 0.0005, 0.001, 0.005, 0.01]   # Assign a list of floats in the block below
### YOUR CODE HERE
...
ind = np.argmax(dev)
print ind
BEST_REGULARIZATION = REGULARIZATION[ind]
BEST_WEIGHTS = weig[ind]
